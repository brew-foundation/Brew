...
This document describes our policies and procedures on the collection, handling, and disclosure of user information.

Information received (statistics, insights, etc.) from **You** will be used to improve **Brew Services**  By using the 
...
means equity interest or other securities entitled to vote for election of directors or other managing authority.
- **Application** means the software program provided by the **Company** downloaded by **You** on any electronic
device, named **Brew**
- **Company** (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to **Brew Foundation.**
...
The Personal Data You provide can give **You** access to different functionalities of the **Service** that are available 
...
to another company.
- With **Affiliate(s)**: We may share **Your** information with **Our** affiliates, in which case we will require those 
affiliates to honor this Privacy Policy. Affiliates include **Our** parent company and or foundation and any other 
...
Usage Data is generally retained for a shorter period of time, except when this data is used to strengthen the security 
...
places where the parties involved in the processing are located. It means that this information may be transferred to — 
and maintained on — computers located outside **Your** state, province, country or other governmental jurisdiction where
...
If **You** requests an **Account** deletion, **We** will follow our policies handling data and will be deletion upon request.
...
- By email: brewfoundation@outlook.com
